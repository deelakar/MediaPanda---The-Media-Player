...
void PlayerWindow::on_directory_clicked()
{
    QString path = QFileDialog::getOpenFileName(this,
                   tr("Open a file"), "/home/", tr("Audio (*.mp3);;Video (*.mp4)"));
    QFile f(path);
...
void PlayerWindow::on_actionInfo_triggered()
{
    ...
    mssInfo.setText("This media player is developed by Deelaka Rathnayake. Media player supports MP4 video files & mp3 audio files only. To work with the media player it is required to install codec software.");
    mssInfo.exec();
}
